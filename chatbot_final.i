  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/mtheogit/chatbot-final/blob/main/chatbot_final.i\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "outputs": [
        {
          ...
          "output_type": "stream",
          "text": [
            "🔑 Digite sua chave da API Gemini (ex: AIza...): AIzaSyA0VPus7WM77XcTeoOz7ZwztNJL0dmZMtI\n"
          ]
        }
      ],
      "source": [
    ...
    },
    {
      ...
      "source": [
        ...
        "    fn=responder,\n",
        "    inputs=[\n",
        "        gr.Textbox(label=\"💬 Pergunta (texto ou sobre uma imagem)\", placeholder=\"Ex: O que você vê nesta imagem?\", lines=2),\n",
        "        gr.Image(type=\"filepath\", label=\"🖼 Envie uma imagem (opcional)\")\n",
        "    ],\n",
        "    outputs=gr.Textbox(label=\"🤖 Resposta da MauMau.IA\"),\n",
        "    title=\"🔥 MauMau.IA 🔥\",\n",
